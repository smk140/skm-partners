...
export default function Home() {
  const [companyInfo, setCompanyInfo] = useState<CompanyInfo>({
    ...
    phone: "",
    email: "",
    description: "공실률 ZERO를 위한 스마트 건물 관리 솔루션",
    site_images: {},
  })
        ...
        <div
          ...
          style={{
            backgroundImage: `url('${getImageUrl(
              ...
              "/placeholder.svg?height=600&width=1200&text=SKM파트너스+메인+Hero",
            )}')`,
          }}
        ></div>
            ...
            {[
              {
                ...
                image: getImageUrl(
                  ...
                  "/placeholder.svg?height=200&width=300&text=건물관리+서비스",
                ),
              },
              {
                icon: (
              ...
              >
                <div className="relative h-48 bg-slate-100">
                  <img
                    ...
                    onError={(e) => {
                      console.log("이미지 로드 실패:", service.image)
                      e.currentTarget.src = "/placeholder.svg?height=200&width=300&text=" + service.title
                    }}
                    onLoad={() => {
                      console.log("이미지 로드 성공:", service.image)
                    }}
                  />
